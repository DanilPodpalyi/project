...
"""Тесты поиска вакансий через API hh.ru."""
...
from resume_evaluator.vacancy_search import (
    DEFAULT_USER_AGENT,
    VacancySearchError,
    build_search_url,
    fetch_search_data,
...
class VacancySearchTests(unittest.TestCase):
    ...
    @patch("resume_evaluator.vacancy_search.urlopen")
    ...
    @patch("resume_evaluator.vacancy_search.fetch_search_data")
