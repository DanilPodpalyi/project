"""Экспериментальный поиск вакансий через API hh.ru.

ВНИМАНИЕ: на момент минимальной приёмки модуль не работает и не входит в
поддерживаемый основной конвейер. Код сохранён как заготовка для последующей
диагностики и доработки интеграции с hh.ru.
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Структурированный JSON, созданный модулем resume_extractor"
        ),
    )
    parser.add_argument(
        "output",
